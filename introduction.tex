...
The results of the experiments demonstrate clear taking a snapshot using  ABS technique with added support for cyclic topologies requires slightly more execution time compared to simple ABS, but in the experimental program the difference is not really significant. If we compare the time of convergence in case of using any back-up technique to pure execution, the measurements proves that due to asynchronous and lightweight nature of ABS the execution time barely changes.
