...
\textit{Active standby} uses process pairs as \textit{passive standby}, but it in contrast to passive  version it processess al the input tuples in parallel with the primary  
